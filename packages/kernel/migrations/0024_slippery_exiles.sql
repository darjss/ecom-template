...
INSERT INTO `__new_orders`("id", "order_number", "state", "customer_id", "customer_linked_at", "status_token_hash", "recipient_name", "recipient_phone", "currency", "subtotal_mnt", "discount_total_mnt", "delivery_fee_mnt", "grand_total_mnt", "free_delivery_threshold_mnt", "free_delivery_applied", "commerce_settings_updated_at", "fulfillment_mode", "delivery_address", "pickup_location_id", "pickup_name", "pickup_address", "commercial_fingerprint", "placed_at", "created_at") SELECT "id", "order_number", "state", NULL, NULL, NULL, "recipient_name", "recipient_phone", "currency", "subtotal_mnt", "discount_total_mnt", "delivery_fee_mnt", "grand_total_mnt", "free_delivery_threshold_mnt", "free_delivery_applied", "commerce_settings_updated_at", "fulfillment_mode", "delivery_address", "pickup_location_id", "pickup_name", "pickup_address", "commercial_fingerprint", "placed_at", "created_at" FROM `orders`;--> statement-breakpoint
