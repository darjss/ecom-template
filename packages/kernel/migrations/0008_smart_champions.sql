...
CREATE TABLE `inventory_entries` (
	...
	CONSTRAINT "inventory_entries_balance_check" CHECK("inventory_entries"."resulting_on_hand_quantity" >= 0 AND "inventory_entries"."resulting_reserved_quantity" >= 0 AND "inventory_entries"."resulting_reserved_quantity" <= "inventory_entries"."resulting_on_hand_quantity")
);
--> statement-breakpoint
...
CREATE TABLE `skus` (
	...
	CONSTRAINT "skus_compact_check" CHECK(length("skus"."sku_compact") BETWEEN 1 AND 64)
);
--> statement-breakpoint
