...
export const ProductShelf = (props: ProductShelfProps) => (
  <section class="u48-catalog" aria-labelledby="u48-catalog-title">
    <div class="u48-section-heading">
      <div>
        <p>Ө48 Өдөр</p>
        <h2 id="u48-catalog-title">Өдөр тутмын тавиур</h2>
      </div>
      <button type="button">
        Бүгдийг үзэх <ArrowRight aria-hidden="true" />
      </button>
    </div>
    <div class="u48-shelf-grid">
      <For each={props.products.slice(0, 8)}>
        {(product, index) => (
          <article class={`u48-product u48-product-${index() + 1}`}>
            <button
              class="u48-product-image"
              type="button"
            ...
            <div class="u48-product-copy">
              ...
              <div class="u48-product-buy">
                ...
                <button
                  ...
                  aria-label={`${product.shortName} сагсанд нэмэх`}
                >
                  <Show when={product.status !== "out"} fallback="Дууссан">
