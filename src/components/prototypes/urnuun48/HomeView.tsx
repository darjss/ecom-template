  ...
  <main id="main-content">
    ...
    <section class="u48-hero">
      <div class="u48-hero-copy">
        ...
        <h1>Гэрийн тавиураа<br /><span>нэг дороос</span></h1>
        <p>Гал тогоо, гэр ахуй, жижиг бэлгийн хэрэгцээг ойлгомжтой сонгоорой.</p>
        <button type="button" onClick={() => document.querySelector("#u48-catalog-title")?.scrollIntoView({ behavior: "smooth" })}>
          Өнөөдрийн сонголт <ArrowRight aria-hidden="true" />
        </button>
      </div>
      <div class="u48-hero-image">
        <img src="/prototypes/urnuun48/media/hero-pantry.webp" alt="Өрнүүн 48-ын зохиомол хүнс, гэр ахуйн бүтээгдэхүүнтэй модон тавиур" width="1000" height="1000" />
        <div class="u48-hero-tag"><b>120,000₮</b><span>дээш хүргэлт үнэгүй</span></div>
      </div>
      <div class="u48-hero-side">
        <p>Шинэ гэр</p><strong>Цэвэрхэн эхлэх<br />бэлэн багцууд</strong>
        <button type="button" onClick={() => props.onOpen("B01")}>Багц үзэх <ArrowRight aria-hidden="true" /></button>
      </div>
    </section>
    ...
    <section class="u48-assurance" aria-label="Үйлчилгээний мэдээлэл">
      <div><Truck aria-hidden="true" /><span><b>6,000₮ хүргэлт</b>Улаанбаатар хотод</span></div>
      <div><MapPin aria-hidden="true" /><span><b>Үнэгүй авах</b>Жишиг цэгээс</span></div>
      <div><PackageCheck aria-hidden="true" /><span><b>Бодит үлдэгдэл</b>Захиалахад дахин шалгана</span></div>
    </section>
  </main>
);
