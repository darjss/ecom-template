...
| `wf29.cod.pickup` | Verify the runtime canary phone, then place a Customer Pickup Order: 2 × P01 + 1 × P03; COD | total 16,300 and fee 0; placement immediately consumes inventory and creates an Awaiting Confirmation cash Payment; Pickup and exact cash confirmation permit completion |
